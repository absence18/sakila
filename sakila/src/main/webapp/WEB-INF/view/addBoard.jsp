	...
	<div class="container">
		...
		<form id="addForm"
			...
			<div>
				...
				<div id="inputFile">
					<!-- 파일 추가 버튼을 누르면 파일찾는게 생김 -->
					<!--<div></div>-->
					<!-- 자식까지는 생성 가능하지만 자식의 자식은 생성 x -->
				</div>
			</div>
			...
			<div class="form-group">
				<label for="boardPw">boardTitle :</label> <input
					class="form-control" name="board.boardTitle" id="boardTitle"
					type="text">
			</div>
			<div class="form-group">
				<label for="boardContent">boardContent :</label>
				<textarea class="form-control" name="board.boardContent"
					id="boardContent" rows="5" cols="50"></textarea>
			</div>
			<div class="form-group">
				<label for="staffId">staffId :</label> <input class="form-control"
					name="board.staffId" id="staffId" type="text">
			</div>
			<div>
