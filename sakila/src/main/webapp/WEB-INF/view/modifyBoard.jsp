...
<body>
	<div class="container">
		...
		<form action="${pageContext.request.contextPath}/admin/modifyBoard"
			...
			<table class="table">
				<tbody>
					...
					<tr>
						<td>boardPw :</td>
						<td><input type="password" id="boardTPw" name="boardPw">
						</td>
					</tr>
					<tr>
						<td>boardContent :</td>
						<td><textarea id="boardContent" name="boardContent" rows="5"
